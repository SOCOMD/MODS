...
class SOCOMD_Item_Primary_Breacher                  : arifle_SPAR_01_blk_F {scope = protected;};
...
class SOCOMD_Item_Handgun_Breacher                  : DSO_hgun_Pistol_heavy_01_blk_F {scope = protected;};
...
class SOCOMD_Item_Secondary_Breacher                : ItemCore {scope = protected;};
...
class SOCOMD_Item_Binocular_Breacher                : Binocular {scope = protected;};
...
class SOCOMD_Item_GPS_Breacher                      : ItemMicroDAGR {scope = protected;};
...
class SOCOMD_Item_Uniform_Breacher                  : SOCOMD_Uniform_SleevesDown {scope = protected;};
...
class SOCOMD_Item_Vest_Breacher                     : lbt_tl_mc {scope = protected;};
