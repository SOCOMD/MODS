//
//	
if (VQI_CORE_HINTS == 1) then { hint "supportradio_call_apc.sqf"; };
sleep 1;
...
_logic sideChat "Solid Copy! Stand By... Systems Check..."; sleep (2 + random 5);
_logic sideChat "APC Oscar Mike";
sleep 30;
//---------------------------------------------------------------------------------------------------------
...
_hPos = [_uPos, 1500, 2500, 20, 1, 0.5] call BIS_fnc_findSafepos;

// pos, dir, "classname", side/group				
_armr = [_hPos, 180, "B_APC_Wheeled_01_cannon_F", WEST] call bis_fnc_spawnvehicle;
APC0 = _armr select 0;	// apc object
APC1 = _armr select 1;
APC2 = _armr select 2;	// apc group
sleep 2;
...
_wp0 = APC2 addWaypoint [_gpsLOC, 0]; 
...
// addActions
APC0 addAction ["APC - Return to Base","[APC0] execVM 'vqi_core\VQI-StartingOptions\Support\SupportRadio\vqi_core_supportradio_call_apcrtb.sqf'"];
APC0 addAction ["APC - Combat Patrol: 500m",{ [group APC0, getPos APC0, 500] call BIS_fnc_taskPatrol;} ];
APC0 addAction ["APC - Combat Patrol: 1km",{ [group APC0, getPos APC0, 1000] call BIS_fnc_taskPatrol;} ];
APC0 addAction ["APC - Combat Patrol: 2km",{ [group APC0, getPos APC0, 2000] call BIS_fnc_taskPatrol;} ];
APC0 addAction ["APC - Transport: Map-Click","[APC0] execVM 'vqi_core\VQI-StartingOptions\Support\SupportRadio\vqi_core_supportradio_call_apctransport.sqf'"];
APC0 addAction ["APC - STOP!",{ driver APC0 disableAI "MOVE"; sleep 30; driver APC0 enableAI "MOVE";} ];
