...
if (true) then { // 95% of Command approval - SAMs later
	...
	xX = random 150; // random area, apprx 1km2+
	publicVariable "xX";
	yY = random 150; // x+y=area
	publicVariable "yY";
	zZ = 1111 + random 2222; // z is your height (3600'-11k')
	publicVariable "zZ";
...
"mkrJmpDD" setMarkerText format [" New Flight - ParaJump - %1ft",_mkAlt];
"mkrJmpDD" setMarkerAlpha 1;

sleep 1;

/* NOT Needed in standard low-level ParaJump
