...
CARGO_PARACARGO = "B_CargoNet_01_ammo_F" createVehicle position VQI_HALO_JUMPCRAFT;
CARGO_PARACARGO attachTo [VQI_HALO_JUMPCRAFT,[0.5, 2, -3.7]];
...
CARGO_BEACONRADAR attachTo [CARGO_PARACARGO,[0, 0.83, -0.5]];
