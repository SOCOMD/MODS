...
CARGO_PARACARGO = "B_Quadbike_01_F" createVehicle position VQI_HALO_JUMPCRAFT;
CARGO_PARACARGO attachTo [VQI_HALO_JUMPCRAFT,[0.7, 2, -2.9]];	// x, 9, x
...
CARGO_BEACONRADAR attachTo [CARGO_PARACARGO,[0, 1, -1]];
