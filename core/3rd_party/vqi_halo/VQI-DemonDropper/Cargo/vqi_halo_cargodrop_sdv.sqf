...
CARGO_PARACARGO = "B_SDV_01_F" createVehicle position VQI_HALO_JUMPCRAFT;
CARGO_PARACARGO attachTo [VQI_HALO_JUMPCRAFT,[0.6, 4.5, -2.8]];
CARGO_PARACARGO allowDamage false;
publicVariable "CARGO_PARACARGO";
sleep 1;
CARGO_PARACARGO animate ["Periscope", 3];
CARGO_PARACARGO animate ["Antenna", 3];
...
CARGO_BEACONRADAR attachTo [CARGO_PARACARGO,[0, 1.85, -1.6]];
