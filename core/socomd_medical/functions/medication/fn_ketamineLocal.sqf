...
_radialEffect = ppEffectCreate ["radialBlur", 2002];       //Enable PPeffect  
_ColorEffect = ppEffectCreate ["ColorInversion", 2006];       //Enable PPeffect  
_WetEffect = ppEffectCreate ["WetDistortion", 2001];       //Enable PPeffect  
