...
class SOCOMD_Item_Handgun_Marsksman                 : ItemCore {scope = protected;};
...
class SOCOMD_Item_Secondary_Marsksman               : srifle_LRR_F {scope = protected;};
...
class SOCOMD_Item_Binocular_Marsksman               : Laserdesignator {scope = protected;};
