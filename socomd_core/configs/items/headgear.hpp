...
class SOCOMD_Cap_HS_Rev: H_Booniehat_khk {
	author = AUTHOR_STR;
	scope = 1;
...
//LARGE HEADSET
class SOCOMD_Cap_HS: H_Cap_headphones {
	author = AUTHOR_STR;
	scope = 2;
...
//SMALL HEADSET BUT NOT
class SOCOMD_Boonie: H_Booniehat_khk_hs {
	author = AUTHOR_STR;
	scope = 2;
...
class SOCOMD_Bandanna: H_Bandanna_khk_hs {
	author = AUTHOR_STR;
	scope = 2;
...
class SOCOMD_FAST_Tan_Gog: H_HelmetB {
	author = AUTHOR_STR;
	scope = 1;
...
//FAST NO GOGGLES
class SOCOMD_FAST_Tan: H_HelmetB {
	author = "SOCOMD & massi";
	scope = 2;
...
class SOCOMD_MICH_Tan_Gog: H_HelmetB {
	author = "SOCOMD & massi";
	scope = 1;
...
class SOCOMD_MICH_Tan: H_HelmetB {
	author = "SOCOMD & massi";
	scope = 2;
