...
force force ace_medical_treatment_cprSuccessChanceMax = 0.3;														 
...
force force ace_medical_treatment_treatmentTimeTourniquet = 1;
...
force force crowsZA_zeus_rc_helper = true;
force force crowsZA_zeusTextLine1 = true;
force force crowsZA_zeusTextLine2 = true;
force force crowsZA_zeusTextLine3 = true;
...
force force grad_trenches_functions_buildFatigueFactor = 0.15;
...
// Improved Craters
force force IC_setting_allowAdjustObjects = true;
force force IC_setting_allowDebris = true;
force force IC_setting_allowGroundTextures = true;
force force IC_setting_craterDepthScale = 1;
force force IC_setting_craterDiameterScale = 1;
force force IC_setting_limitDebris = true;
force force IC_setting_limitGroundTextures = true;
force force IC_setting_maxDebris = 59.5152;
force force IC_setting_maxDebrisCountPerCrater = 3.69884;
force force IC_setting_maxGroundTextures = 100;

// KAT - ADV Medical: Airway
force force kat_airway_Accuvac_time = 8;
force force kat_airway_CancelRecoveryPosition_Time = 3.4;
...
force force kat_breathing_deterioratingPneumothorax_countdown = 3600;
...
force force kat_circulation_AED_MinChance = 70.4602;
force force kat_circulation_AED_X_MaxChance = 90;
force force kat_circulation_AED_X_MinChance = 80;
...
force force lambs_eventhandlers_ExplosionReactionTime = 10;
...
force force lambs_main_indoorMove = 0.4;
...
force force vtx_uh60_flir_setting_syncDelay = 0.1;
force force vtx_uh60m_enabled_aar = false;
force force vtx_uh60m_enabled_cas = false;
force force vtx_uh60m_enabled_engine = false;
force force vtx_uh60m_enabled_fd = false;
force force vtx_uh60m_enabled_flir = false;
force force vtx_uh60m_enabled_fms = false;
force force vtx_uh60m_enabled_jvmf = false;
force force vtx_uh60m_enabled_mfd = false;
