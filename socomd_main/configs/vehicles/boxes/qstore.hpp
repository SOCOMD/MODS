	...
	class ACE_Actions {
		class ACE_MainActions {
			...
			QSTORE_ACTION_GRP_BEGIN(SELECT_WEAPON,"Weapons")
				...
				QSTORE_ACTION_WEAPON_PRIMARY("m107",Sniper_Barret)

				QSTORE_ACTION_WEAPON_PRIMARY("AWM",SOCOMD_Item_Primary_Recon)
				QSTORE_ACTION_WEAPON_PRIMARY("AWM",SOCOMD_Item_Primary_Sniper)
			...
			QSTORE_ACTION_GRP_BEGIN(SELECT_LAUNCHER,"Launcher")
				...
				QSTORE_ACTION_WEAPON_SECONDARY("Javelin",CUP_launch_Javelin)
			QSTORE_ACTION_GRP_END
		};
	};
};