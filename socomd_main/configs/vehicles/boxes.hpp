...
class SOCOMD_Archer_Crate: NATO_Box_Base
{
	...
	class TransportWeapons 
	{
		...
		TRANSPORT_WEAPON(UK3CB_BAF_Javelin_Slung_Tube, 2);
...
class SOCOMD_Sniper_Crate: NATO_Box_Base
{
	...
	class TransportWeapons
	{
		TRANSPORT_WEAPON(UK3CB_BAF_L115A3_Desert, 1);
		TRANSPORT_WEAPON(UK3CB_BAF_L115A3_Desert_Ghillie, 1);
	...
	class TransportMagazines
	{
		TRANSPORT_MAGAZINE(5Rnd_127x108_Mag, 16);
		TRANSPORT_MAGAZINE(5Rnd_127x108_APDS_Mag, 16);
...
class SOCOMD_Mag58_Crate: NATO_Box_Base
{
	...
	class TransportMagazines 
	{
		TRANSPORT_MAGAZINE(UK3CB_BAF_150Rnd_762x51_Box, 8);
		TRANSPORT_MAGAZINE(UK3CB_BAF_75Rnd, 20);
		TRANSPORT_MAGAZINE(UK3CB_BAF_75Rnd_T, 16);
	};
};
