...
class ASORVS_MinusButton :ASORVS_RscShortcutButton
{
	...
	animTextureDefault = "#(rgb,8,8,3)color(0.15,0.15,0.15,1)";
	animTextureNormal = "#(rgb,8,8,3)color(0.15,0.15,0.15,1)";
...
class ASORVS_Main_Dialog {
	...
	class controls {
		...
		class closeButton : ASORVS_PlusButton {
			...
			colorBackground[] = {1,1,1,1};
			animTextureDefault = "#(rgb,8,8,3)color(0.5,0,0,1)";
			animTextureNormal = "#(rgb,8,8,3)color(0.5,0,0,1)";
			animTextureDisabled =  "#(rgb,8,8,3)color(0.05,0.05,0.05,1)";
