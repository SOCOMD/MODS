...
set modOutput_cup_compat="C:\Program Files (x86)\Steam\steamapps\common\Arma 3\SOCOMD_Mods\SOCOMD_Dev\@socomd_cup_compat\addons"
set modOutput_rhs_compat="C:\Program Files (x86)\Steam\steamapps\common\Arma 3\SOCOMD_Mods\SOCOMD_Dev\@socomd_rhs_compat\addons"
...
start /D %projectDir% makepbo.exe -N socomd_cup_compat %modOutput_cup_compat%
start /D %projectDir% makepbo.exe -N socomd_rhs_compat %modOutput_rhs_compat%