...
def main():
    ...
    print("""
  ######################################
  # SOCOMD Development Environment Setup #
  ######################################

  This script will create your SOCOMD dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your SOCOMD project folder:
    [Arma 3 installation directory]\\{} => SOCOMD project folder
    P:\\{}                              => SOCOMD project folder
