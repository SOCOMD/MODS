...
class SOCOMD_QStore_A : SOCOMD_QStore_Base {
	...
	class ACE_Actions {
		class ACE_MainActions {
			...
			// 		QSTORE_ACTION_WEAPON_PRIMARY("Black",S_M4A5_145_troy_base)
			...
			// 		QSTORE_ACTION_WEAPON_PRIMARY("Black",hlc_rifle_416D10)
			// 		QSTORE_ACTION_WEAPON_PRIMARY("Tan",hlc_rifle_416D10_tan)
			// 		QSTORE_ACTION_WEAPON_PRIMARY("OD",hlc_rifle_416D10_wdl)
			// 	QSTORE_ACTION_GRP_END
			...
			// 		QSTORE_ACTION_WEAPON_PRIMARY("Black",S_kio_sr25_camo_black)
			// 		QSTORE_ACTION_WEAPON_PRIMARY("Tan",S_kio_sr25_camo)
			// 		QSTORE_ACTION_WEAPON_PRIMARY("OD",S_kio_sr25_ec)
			// 	QSTORE_ACTION_GRP_END
