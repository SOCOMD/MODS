...
#define INVENTORY_VEHICLE_DEFAULT_MAGAZINES \
	TRANSPORT_MAGAZINE(SOCOMD_Item_Magazine_556x45_30Rnd, 3) \
	TRANSPORT_MAGAZINE(SOCOMD_Item_Magazine_762x51_20Rnd, 0) \
	TRANSPORT_MAGAZINE(SOCOMD_Item_Magazine_556x45_200Rnd_Tracer, 0) \
	TRANSPORT_MAGAZINE(SOCOMD_Item_Magazine_762x51_150Rnd_Tracer, 0) \
	TRANSPORT_MAGAZINE(SmokeShellBlue, 0) \
	TRANSPORT_MAGAZINE(B_IR_Grenade, 0)
