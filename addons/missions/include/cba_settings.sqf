...
force force grad_civs_lifecycle_minCivUpdateTime = 3.99204;
...
force force grad_civs_patrol_maxCivsOnFoot = 25.396;
force force grad_civs_patrol_spawnDistancesOnFoot = "[1000, 3000]";
force grad_civs_residents_chatTime = 20;
force force grad_civs_residents_maxCivsResidents = 20;
