...
ace_cookoff_probabilityCoef = 0.7;
...
ace_interact_menu_more__ace_zeus_delete = true;
...
ace_repair_wheelRepairRequiredItems = ["ToolKit"];
...
ace_medical_spontaneousWakeUpChance = 0.701618;
...
ace_medical_treatment_cprSuccessChanceMax = 0.05;														 
ace_medical_treatment_cprSuccessChanceMin = 0.05;
...
ace_medical_treatment_woundReopenChance = 0.656423;
...
kat_circulation_CPR_Chance_Default = 5;
kat_circulation_CPR_Chance_Doctor = 5;
kat_circulation_CPR_Chance_RegularMedic = 5;
...
ace_overheating_jamChanceCoef = 1.0;
...
// CUP
CUP_Vehicles_PreventBarrelClip = false;
...
lambs_eventhandlers_ExplosionReactionTime = 20.0;
...
// SOCOMD Medical
SOCOMD_medical_persistantRevive = true;
SOCOMD_medical_persistantReviveTimer = 330;
