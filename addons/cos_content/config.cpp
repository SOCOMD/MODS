...
class CfgVehicles
{
    ...
    class SOCOMD_PARA_VOILE: Steerable_Parachute_F
    {
        ...
        model = "z\socomd\addons\cos_content\PARA_VOILE";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"z\socomd\addons\cos_content\data\parachute\Parachute_co.paa"};
    };
    class SOCOMD_COS_PARACHUTE: B_Parachute
    {
        ...
        model = "z\socomd\addons\cos_content\COS_PARACHUTE";
    ...
    class SOCOMD_drybag_od: B_Bergen_Base
    {
        ...
        model = "z\socomd\addons\cos_content\drybag";
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"z\socomd\addons\cos_content\data\drybag\DryBag_od_co.paa"};
        hiddenSelectionsMaterials[] = {"z\socomd\addons\cos_content\data\drybag\drybag.rvmat"};
        hiddenUnderwaterSelections[] = {"hide"};
        shownUnderwaterSelections[] = {"unhide","unhide2"};
        hiddenUnderwaterSelectionsTextures[] = {"z\socomd\addons\cos_content\data\halo\diver_kit_co.paa","z\socomd\addons\cos_content\data\halo\diver_kit_co.paa","A3\characters_f\data\visors_ca.paa"};
        maximumLoad = 450;
        mass = 33;
    };
    class SOCOMD_drybag_blk: SOCOMD_drybag_od
    {
        ...
        hiddenSelections[] = {"camo"};
        hiddenSelectionsTextures[] = {"z\socomd\addons\cos_content\data\drybag\DryBag_blk_co.paa"};
        hiddenSelectionsMaterials[] = {"z\socomd\addons\cos_content\data\drybag\drybag.rvmat"};
        hiddenUnderwaterSelections[] = {"hide"};
        shownUnderwaterSelections[] = {"unhide","unhide2"};
        hiddenUnderwaterSelectionsTextures[] = {"z\socomd\addons\cos_content\data\halo\diver_kit_co.paa","z\socomd\addons\cos_content\data\halo\diver_kit_co.paa","A3\characters_f\data\visors_ca.paa"};
