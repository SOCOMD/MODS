...
class B_Slingload_01_Medevac_F : Slingload_01_Base_F {
    class ACE_Actions {
        class ACE_ZeusHeal {
            ...
            statement = "_player setdamage 0; [objNull, _player] call ace_medical_treatment_fnc_fullHeal;";
        };
    };
};

// OLD
// _player setVariable ['SOCOMD_REVIVAL', SOCOMD_medical_persistantReviveTimer, true]