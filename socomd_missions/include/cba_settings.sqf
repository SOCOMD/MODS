...
force force ace_finger_indicatorForSelf = false;
...
force force ace_hearing_earplugsVolume = 0.9;
force force ace_hearing_unconsciousnessVolume = 0.9;
...
force force VCM_ARTYSPREAD = 500;
...
force force VCM_STATICARMT = 30;
force force VCM_StealVeh = false;
force force VCM_WARNDELAY = 120;
