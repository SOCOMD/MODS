...
class ASORVS_RscStructuredText{
	colorText[]={1,1,1,1};
	class Attributes{
		font="PuristaMedium";
		color="#ffffff";
...
class ASORVS_RscPicture{colorBackground[]={0,0,0,0};
	colorText[]={1,1,1,1};
	tooltipColorText[]={1,1,1,1};
	tooltipColorBox[]={1,1,1,1};
	tooltipColorShade[]={0,0,0,0.65};
...
class ASORVS_RscListBox{colorText[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
...
class ASORVS_RscButton{colorText[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
...
class ASORVS_RscShortcutButton{
	class HitZone{
		left=0;
		top=0;
		right=0;
...
class  ASORVS_RscShortcutButtonMain{
	color[]={1,1,1,1};
	colorDisabled[]={1,1,1,0.25};
	class  HitZone{
		left=0;
...
class ASORVS_RscButtonMenu : ASORVS_RscShortcutButton{
	idc=-1;
	type=16;
	style="0x02 + 0xC0";
	default=0;
