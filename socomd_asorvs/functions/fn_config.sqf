...
//ASORVS_Whitelist ["SOCOMD_ASLAV", "SOCOMD_JACKAL_HMG_D", "SOCOMD_JACKAL_AGL_D", "SOCOMD_JACKAL_HMG_W", "SOCOMD_JACKAL_AGL_W", "SOCOMD_BUSHMASTER_HMG", "SOCOMD_BUSHMASTER_TRANS", "SOCOMD_BLACKHAWK", "SOCOMD_CHINOOK", "SOCOMD_HURRICANE_AA", "SOCOMD_HURRICANE_AT", "SOCOMD_HURRICANE_CAS", "SOCOMD_FIREFLY", "SOCOMD_DRAGONFLY_127", "SOCOMD_DRAGONFLY_762", "SOCOMD_LCH", "SOCOMD_ASSAULT_BOAT", "SOCOMD_ASSAULT_BOAT_S", "SOCOMD_GUNBOAT", "SOCOMD_SUPPORT_HMG_D", "SOCOMD_SUPPORT_HMG_W", "SOCOMD_QUADBIKE", "SOCOMD_BIKE"];
