 ...
 *
 * Example:
 * [player, cursorObject] call socomd_defib_fnc_AEDStationCondition
 *
 * Public: No
 */
...
{
	if (typeOf _x isEqualTo "socomd_defib_AEDItem" || typeOf _x isEqualTo "Land_Defibrillator_F") then {
