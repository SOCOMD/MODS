	...
	class ACE_Actions {
		class ACE_MainActions {
			...
			QSTORE_ACTION_GRP_BEGIN(SELECT_WEAPON,"Weapons")
				QSTORE_ACTION_WEAPON("M4",SMA_M4afgSTOCK)
				QSTORE_ACTION_WEAPON("MK18",SMA_MK18MOEBLK_SM)
				QSTORE_ACTION_WEAPON("AUG A3",SMA_AUG_A3_F)
				QSTORE_ACTION_WEAPON("HK416",SMA_HK416CUSTOMCQBvfgB)

				QSTORE_ACTION_WEAPON("M4 (GL)",SMA_M4_GL_SM)
				QSTORE_ACTION_WEAPON("MK18 (GL)",SMA_MK18BLK_GL_SM)
				QSTORE_ACTION_WEAPON("AUG A3 (GL)",SMA_AUG_EGLM)
				QSTORE_ACTION_WEAPON("HK416 (GL)",SMA_HK416GLCQB_B)

				QSTORE_ACTION_WEAPON("HK417",SMA_HK417_16in)
				QSTORE_ACTION_WEAPON("HK417 (VFG)",SMA_HK417vfg)
