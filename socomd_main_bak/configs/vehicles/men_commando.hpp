...
class SOCOMD_Soldier_LongSleeve : B_Soldier_02_f
{
	...
	hiddenSelectionsTextures[] 	= { "socomd_data_core\uniform\clothes\ia_soldier_01_clothing_co.paa" };
...
class SOCOMD_Officer_LongSleeve : SOCOMD_Soldier_LongSleeve
{
	...
	hiddenSelections[]			= { "Camo", "Insignia" };
	hiddenSelectionsTextures[] 	= { "socomd_data_core\uniform\clothes\ia_officer_01_clothing_co.paa" };
};
...
class SOCOMD_Soldier_DPDU_SleevesDown : ADFU_Soldier_MC 
{
	...
	hiddenSelectionsTextures[]=
		{
			"socomd_data_core\CTgear\u_g3_DPDU_co.paa"
		};
};
...
class SOCOMD_Soldier_DPCU_SleevesDown : ADFU_Soldier_MC 
{
	...
	hiddenSelectionsTextures[]=
		{
			"socomd_data_core\CTgear\u_g3_DPCU_co.paa"
		};
};
...
class SOCOMD_Soldier_DPDU_OD_SleevesDown : ADFU_Soldier_MC 
{
	...
	hiddenSelectionsTextures[]=
		{
			"socomd_data_core\CTgear\u_g3_DPDU_OD_co.paa"
		};
};
...
class SOCOMD_Soldier_DPCU_OD_SleevesDown : ADFU_Soldier_MC 
{
	...
	hiddenSelectionsTextures[]=
		{
			"socomd_data_core\CTgear\u_g3_DPCU_OD_co.paa"
		};
};
