	...
	class ACE_Actions
	{
		class ACE_MainActions
		{
			...
			QSTORE_ACTION_GRP_BEGIN(SELECT_WEAPONS,"Weapons")
				QSTORE_ACTION_WEAPON_PRIMARY("M4A5",SMA_M4afgSTOCK)
				QSTORE_ACTION_WEAPON_PRIMARY("M4A5 UGL",SMA_M4_GL_SM)
				QSTORE_ACTION_WEAPON_PRIMARY("HK416",SMA_HK416CUSTOMCQBvfgB)
				QSTORE_ACTION_WEAPON_PRIMARY("HK416 UGL",SMA_HK416GLCQB_B)
				QSTORE_ACTION_WEAPON_PRIMARY("MK18 MOE",SMA_MK18MOEBLK_SM)
				QSTORE_ACTION_WEAPON_PRIMARY("MK18 MOE UGL",SMA_MK18BLK_GL_SM)
				QSTORE_ACTION_WEAPON_PRIMARY("AUG A3",SMA_AUG_A3_F)
				QSTORE_ACTION_WEAPON_PRIMARY("AUG A3 UGL",SMA_AUG_EGLM)
				QSTORE_ACTION_WEAPON_PRIMARY("Minimi",CUP_lmg_m249_pip2)
				QSTORE_ACTION_WEAPON_PRIMARY("Maximi",sma_minimi_mk3_762tsb)
				QSTORE_ACTION_WEAPON_PRIMARY("Mk14 EBR",SPARTAN_EBR_black_F)
				QSTORE_ACTION_WEAPON_PRIMARY("HK 417",SMA_HK417_16in)
				QSTORE_ACTION_WEAPON_PRIMARY("HK 417 (Assaulter)",SMA_HK417vfg)
				QSTORE_ACTION_WEAPON_PRIMARY("SR98 .300",hlc_rifle_awmagnum)
				QSTORE_ACTION_WEAPON_PRIMARY("SR98 .300 Camo",hlc_rifle_awMagnum_OD_ghillie)
				QSTORE_ACTION_WEAPON_PRIMARY("SR98 .300 Suppressed",hlc_rifle_awcovert)
				QSTORE_ACTION_WEAPON_PRIMARY("Barrett",ej_m107)
			QSTORE_ACTION_GRP_END
