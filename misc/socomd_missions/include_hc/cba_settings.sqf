...
force force ace_common_checkPBOsWhitelist = "['VCOM_AI', 'jsrs_soundmod_bullethits', 'jsrs_soundmod_environment', 'jsrs_soundmod_explosions', 'jsrs_soundmod_framework', 'jsrs_soundmod_helicopters', 'jsrs_soundmod_landvehicles', 'jsrs_soundmod_movement', 'jsrs_soundmod_snd_air_vehicles', 'jsrs_soundmod_snd_environment', 'jsrs_soundmod_snd_land_vehicles', 'jsrs_soundmod_snd_movement', 'jsrs_soundmod_snd_warfare', 'jsrs_soundmod_snd_weapons', 'jsrs_soundmod_sonic_cracks', 'jsrs_soundmod_weapons', 'jsrs_soundmod_cup_vehicles', 'jsrs_soundmod_cfg_cup_weapons', 'jsrs_soundmod_cup_weapons', 'jsrs_soundmod_specialist_military_arms_weapons', 'jsrs_soundmod_snd_sea_vehicles', 'jsrs_soundmod_boats', 'jsrs_soundmod_complete_edition_soundfiles', 'jsrs_soundmod_complete_edition', 'L_ES_ES_main', 'L_ES_ES_sounds', 'L_ES_ES_sys', 'monk_jsrs_soundmod_patch']";
...
force force ace_medical_delayUnconCaptive = 0.8;
