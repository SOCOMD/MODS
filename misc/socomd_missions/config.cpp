...
//	FOBs
	...
	ADD(ALIABADLHD,SOCOMD Aliabad LHD (HMAS Canberra),fobs\Aliabad_LHS_HMAS_Canberra.MCN_Aliabad)
...
//	FOBs (Hardcore)
	...
	ADD(ALIABADLHD_HC,SOCOMD [HC] Aliabad LHD (HMAS Canberra),fobs_hc\Aliabad_LHS_HMAS_Canberra.MCN_Aliabad)
