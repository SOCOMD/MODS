...
//	FOBs (Hardcore)
	...
	ADD(BEKETOVARNLD,SOCOMD Beketov FOB (ARNOLD), fobs_hc\Beketov_FOB_Arnold.Beketov)
	ADD(BEKETOVGIBSN,SOCOMD Beketov FOB (ARNOLD), fobs_hc\Beketov_FOB_Gibson.Beketov)
