...
//	FOBs
	...
	ADD(BEKETOVGIBSN,SOCOMD Beketov FOB (ARNOLD), fobs\Beketov_FOB_Gibson.Beketov)
...
//	FOBs (Hardcore)
	...
	ADD(BEKETOVARNLD_HC,SOCOMD Beketov FOB (ARNOLD), fobs_hc\Beketov_FOB_Arnold.Beketov)
	ADD(BEKETOVGIBSN_HC,SOCOMD Beketov FOB (ARNOLD), fobs_hc\Beketov_FOB_Gibson.Beketov)
