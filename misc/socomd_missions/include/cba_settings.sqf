...
force force ace_common_checkPBOsWhitelist = "['VCOM_AI', 'JSRS_Soundmod_Cfg_Air_Vehicles', 'JSRS_Soundmod_Cfg_Bullethits', 'JSRS_Soundmod_Cfg_Environment', 'JSRS_Soundmod_Cfg_Explosions', 'JSRS_Soundmod_Cfg_Framework','JSRS_Soundmod_Cfg_Land_Vehicles', 'JSRS_Soundmod_Cfg_Movement', 'JSRS_Soundmod_Cfg_Soniccracks', 'JSRS_Soundmod_Cfg_Weapons', 'JSRS_Soundmod_Snd_Air_Vehicles','JSRS_Soundmod_Snd_Environment', 'JSRS_Soundmod_Snd_Land_Vehicles', 'JSRS_Soundmod_Snd_Movement', 'JSRS_Soundmod_Snd_Warfare', 'JSRS_Soundmod_Snd_Weapons','JSRS_Soundmod_Cfg_CUP_Vehicles', 'JSRS_Soundmod_Cfg_CUP_Weapons', 'JSRS_Soundmod_Cfg_Specialist_Military_Arms_Weapons']";
