...
PROGRAM_CHANNEL("ACRE_PRC152", 3,  "AIR TASKING", 75.3, 75.3)
PROGRAM_CHANNEL("ACRE_PRC152", 4,  "FIRES", 83.1, 83.1)
PROGRAM_CHANNEL("ACRE_PRC152", 5,  "INTER-SECTION-1", 83.8, 83.8)
PROGRAM_CHANNEL("ACRE_PRC152", 6,  "INTER-SECTION-2", 84.5, 84.5)
PROGRAM_CHANNEL("ACRE_PRC152", 7,  "INTER-SECTION-3", 85.2, 85.2)
PROGRAM_CHANNEL("ACRE_PRC152", 8,  "INTER-SECTION-4", 85.9, 85.9)
PROGRAM_CHANNEL("ACRE_PRC152", 9, "INTER-SECTION-5", 86.6, 86.6)
PROGRAM_CHANNEL("ACRE_PRC152", 10, "INTER-SECTION-6", 87.3, 87.3)
PROGRAM_CHANNEL("ACRE_PRC152", 11, "INTER-SECTION-7", 88.0, 88.0)
PROGRAM_CHANNEL("ACRE_PRC152", 12, "INTER-SECTION-8", 88.7, 88.7)
PROGRAM_CHANNEL("ACRE_PRC152", 13, "INTER-SECTION-9", 89.4, 89.4)
...
PROGRAM_CHANNEL("ACRE_PRC117F", 4,  "AIR TASKING", 75.3, 75.3)
