...
PROGRAM_CHANNEL("ACRE_PRC152", 4,  "COMMON-AIR-NET", 83.1, 83.1)
PROGRAM_CHANNEL("ACRE_PRC152", 5,  "AIR-NET-1", 83.8, 83.8)
PROGRAM_CHANNEL("ACRE_PRC152", 6,  "AIR-NET-2", 84.5, 84.5)
PROGRAM_CHANNEL("ACRE_PRC152", 7,  "AIR-NET-3", 85.2, 85.2)
PROGRAM_CHANNEL("ACRE_PRC152", 8,  "AIR-NET-4", 85.9, 85.9)
PROGRAM_CHANNEL("ACRE_PRC152", 9,  "AIR-NET-5", 86.6, 86.6)
PROGRAM_CHANNEL("ACRE_PRC152", 10, "VOODOO-NET", 87.3, 87.3)
